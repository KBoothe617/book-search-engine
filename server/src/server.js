...
import { authenticateToken } from './services/auth.js'; // Import the authentication middleware for handling user authentication via tokens
...
const startApolloServer = async () => {
    ...
    app.use('/graphql', expressMiddleware(server, {
        context: authenticateToken // Pass the authenticateToken function to be used as context middleware
    }));
